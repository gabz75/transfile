...
public class InfoTcpRequired extends Informations
{
     ...
     */
    public InfoTcpRequired(int id, Address address, String msg)
    {
        super(InformationsEnum.TCPREQUIRED);
    ...
    /**
     * Decodes an InfoTcpRequired from the given ByteBuffer
     * @param bbr the ByteBuffer
     * @return a new instance of InfoTcpRequired
            ...
            throws UncompletedPackageException
    {
        ...
        return new InfoTcpRequired(id, address, msg);
    }
